...
* MCH+/HCM embryos originate from a wild-type mother and a homozygous *auts2a* mutant father. The wild-type *auts2a* allele of MCH+/HMC embryos was provided by the mother (*i.e.,* the mutant *auts2a* allele being provided by the father).
* In the contrary, MCH-/HPM embryos originate from a wild-type father and a homozygous *auts2a* mutant mother. The wild-type *auts2a* allele of MCH-/HPC embryos was provided by the father (*i.e.,* the mutant *auts2a* allele being provided by the mother).
